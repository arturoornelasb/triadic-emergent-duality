...
To calibrate the IDVS threshold, we computed 10,000 random D-A-N assignments preserving the marginal distribution of each domain. The null distribution yields: mean max IDVS~=~0.861, $p_{95}$~=~0.931, $p_{99}$~=~0.955. All 8 positive domains (IDVS~=~1.000) exceed the $p_{99}$ threshold. All 8 positive domains exceed $p_{99}$.
...
\bottomrule
\end{tabular}
\caption{Training run progression. V5 solves catastrophic forgetting. V6 scales to 2{,}166 concepts.}
\label{tab:runs}
\end{table}
...
\bottomrule
\end{tabular}
\caption{V5 vs V6 comparison. V6 trades individual accuracy for richer structural discovery.}
\label{tab:v6}
\end{table}
...
This work is part of a family of four papers. Each companion component has its own publication and repository:
...
\begin{itemize}[nosep, leftmargin=*]
    ...
    \item \textbf{triadic-microgpt}: Ornelas Brand, J.~A. (2026). \emph{End-to-End Prime Factorization in a Generative Language Model: Emergent Algebraic Semantics from Joint Training.} Paper: \href{https://doi.org/10.5281/zenodo.19206545}{10.5281/zenodo.19206545}. Repository: \href{https://doi.org/10.5281/zenodo.19207845}{10.5281/zenodo.19207845}.
\end{itemize}
