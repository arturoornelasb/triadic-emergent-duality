...
print('  ' + '=' * 50)
print()
print('  FDR CAVEAT: None of these Spearman correlations survive BH-FDR')
print('  correction when tested jointly (0/12 significant). Low power with')
print('  n=7/14 is the likely cause. See i1_recalc_pvalues.py for details.')
